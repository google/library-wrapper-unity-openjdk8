...
namespace Java.Lang
{
    public class RuntimeException : global::Java.Lang.Exception
    {
        ...
        static RuntimeException()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/lang/RuntimeException");
        ...
        public RuntimeException() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public RuntimeException(global::System.String message) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public RuntimeException(global::System.String message, global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public RuntimeException(global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public RuntimeException(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of RuntimeException.");
                }
        ...
        public static explicit operator IntPtr(RuntimeException wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator RuntimeException(IntPtr rawObject)
        {
            return new RuntimeException(rawObject);
        }
