...
namespace Java.Lang
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Lang.Appendable
        {
            ...
            public global::Java.Lang.Appendable Append(global::Java.Lang.CharSequence csq)
            {
                try
                {
                    ...
                    return new global::Java.Lang.Appendable.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId0, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Lang.Appendable Append(global::Java.Lang.CharSequence csq, int start, int end)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { l = csq.GetRawObject() }, new jvalue { i = start }, new jvalue { i = end }};
            ...
            public global::Java.Lang.Appendable Append(char c)
            {
                try
                {
                    ...
                    return new global::Java.Lang.Appendable.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId2, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Lang.Appendable
        {
            public CallbackHelper() : base("java.lang.Appendable") {}
            ...
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(Append(new global::Java.Lang.CharSequence.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject())));
            }
            else if (methodName == "append" && args.Length == 3)
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(Append(new global::Java.Lang.CharSequence.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject()), (int) args[1], (int) args[2]));
            }
