...
namespace Java.Util
{
    public class ArrayDeque<E> : global::Java.Util.AbstractCollection<E>, global::Java.Util.Deque<E>, global::Java.Lang.Cloneable, global::Java.ExternalType.Java.Io.Serializable where E : class
    {
        ...
        static ArrayDeque()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/util/ArrayDeque");
            ...
            _cachedMethodId14 = AndroidJNI.GetMethodID(_classObject, "offer", "(Ljava/lang/Object;)Z");
            _cachedMethodId15 = AndroidJNI.GetMethodID(_classObject, "remove", "()Ljava/lang/Object;");
            _cachedMethodId16 = AndroidJNI.GetMethodID(_classObject, "poll", "()Ljava/lang/Object;");
            _cachedMethodId17 = AndroidJNI.GetMethodID(_classObject, "element", "()Ljava/lang/Object;");
            _cachedMethodId18 = AndroidJNI.GetMethodID(_classObject, "peek", "()Ljava/lang/Object;");
            _cachedMethodId19 = AndroidJNI.GetMethodID(_classObject, "push", "(Ljava/lang/Object;)V");
            _cachedMethodId20 = AndroidJNI.GetMethodID(_classObject, "pop", "()Ljava/lang/Object;");
            _cachedMethodId21 = AndroidJNI.GetMethodID(_classObject, "descendingIterator", "()Ljava/util/Iterator;");
            _cachedMethodId22 = AndroidJNI.GetMethodID(_classObject, "clone", "()Ljava/util/ArrayDeque;");
            _cachedMethodId23 = AndroidJNI.GetMethodID(_classObject, "spliterator", "()Ljava/util/Spliterator;");
        }

        public ArrayDeque() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public ArrayDeque(int numElements) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { i = numElements }};
        ...
        public ArrayDeque(global::Java.Util.Collection<E> c) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public ArrayDeque(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of ArrayDeque.");
                }
        ...
        public E Pop()
        {
            try
            {
                ...
                if (typeof(E) == typeof(global::System.String))
                {
                    return (E) (global::System.Object) AndroidJNI.CallStringMethod(_rawObject, _cachedMethodId20, args_);
                }
                else
                {
        ...
        public global::Java.Util.Iterator<E> DescendingIterator()
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {};
                return new global::Java.Util.Iterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId21, args_));
            }
            finally
            {
                AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public global::Java.Util.ArrayDeque<E> Clone()
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {};
                return new global::Java.Util.ArrayDeque<E>(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId22, args_));
            }
            finally
            {
                AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public global::Java.ExternalType.Java.Util.Spliterator<E> Spliterator()
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {};
                return new global::Java.ExternalType.Java.Util.Spliterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId23, args_));
            }
            finally
            {
                AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public static explicit operator IntPtr(ArrayDeque<E> wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator ArrayDeque<E>(IntPtr rawObject)
        {
            return new ArrayDeque<E>(rawObject);
        }
