...
namespace Java.Util
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Util.List<E>
        {
            ...
            public global::Java.Util.Iterator<E> Iterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Iterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId3, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public bool AddAll(int index, global::Java.Util.Collection<E> c)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { i = index }, new jvalue { l = c.GetRawObject() }};
            ...
            public E Set(int index, E element)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { i = index }, ToJvalue(element)};
                    if (typeof(E) == typeof(global::System.String))
                    {
            ...
            public global::Java.Util.ListIterator<E> ListIterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.ListIterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId22, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.ListIterator<E> ListIterator(int index)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { i = index }};
                    return new global::Java.Util.ListIterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId23, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.List<E> SubList(int fromIndex, int toIndex)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { i = fromIndex }, new jvalue { i = toIndex }};
                    return new global::Java.Util.List<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId24, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.ExternalType.Java.Util.Spliterator<E> Spliterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.ExternalType.Java.Util.Spliterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId25, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Util.List<E>
        {
            public CallbackHelper() : base("java.util.List") {}
            ...
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(AddAll((int) args[0], new global::Java.Util.Collection<E>.AnonymousImplementation(((AndroidJavaObject) args[1]).GetRawObject())));
            }
