...
namespace Java.Lang
{
    public class Integer : global::Java.Lang.Number, global::Java.ExternalType.Java.Lang.Comparable<global::Java.Lang.Integer>
    {
        ...
        {
            get => new global::Java.Lang.Class<global::Java.Lang.Integer>(AndroidJNI.GetStaticObjectField(_classObject, _cachedFieldId2));
            set
            {
        ...
        public static global::System.String ToString(int i, int radix)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { i = i }, new jvalue { i = radix }};
        ...
        public static global::Java.Lang.Integer GetInteger(global::System.String nm, int val)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = AndroidJNI.NewString(nm) }, new jvalue { i = val }};
        ...
        public static int DivideUnsigned(int dividend, int divisor)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { i = dividend }, new jvalue { i = divisor }};
        ...
        public static int RotateLeft(int i, int distance)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { i = i }, new jvalue { i = distance }};
