...
namespace Java.Util
{
    public class SplittableRandom : global::Google.LibraryWrapper.Java.JavaObject
    {
        ...
        static SplittableRandom()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/util/SplittableRandom");
            ...
            _cachedMethodId0 = AndroidJNI.GetMethodID(_classObject, "split", "()Ljava/util/SplittableRandom;");
            ...
            _cachedMethodId3 = AndroidJNI.GetMethodID(_classObject, "nextInt", "(II)I");
            _cachedMethodId4 = AndroidJNI.GetMethodID(_classObject, "nextLong", "()J");
            _cachedMethodId5 = AndroidJNI.GetMethodID(_classObject, "nextLong", "(J)J");
            _cachedMethodId6 = AndroidJNI.GetMethodID(_classObject, "nextLong", "(JJ)J");
            _cachedMethodId7 = AndroidJNI.GetMethodID(_classObject, "nextDouble", "()D");
            _cachedMethodId8 = AndroidJNI.GetMethodID(_classObject, "nextDouble", "(D)D");
            _cachedMethodId9 = AndroidJNI.GetMethodID(_classObject, "nextDouble", "(DD)D");
            _cachedMethodId10 = AndroidJNI.GetMethodID(_classObject, "nextBoolean", "()Z");
            _cachedMethodId11 = AndroidJNI.GetMethodID(_classObject, "ints", "(J)Ljava/util/stream/IntStream;");
            _cachedMethodId12 = AndroidJNI.GetMethodID(_classObject, "ints", "()Ljava/util/stream/IntStream;");
            _cachedMethodId13 = AndroidJNI.GetMethodID(_classObject, "ints", "(JII)Ljava/util/stream/IntStream;");
            _cachedMethodId14 = AndroidJNI.GetMethodID(_classObject, "ints", "(II)Ljava/util/stream/IntStream;");
            _cachedMethodId15 = AndroidJNI.GetMethodID(_classObject, "longs", "(J)Ljava/util/stream/LongStream;");
            _cachedMethodId16 = AndroidJNI.GetMethodID(_classObject, "longs", "()Ljava/util/stream/LongStream;");
            _cachedMethodId17 = AndroidJNI.GetMethodID(_classObject, "longs", "(JJJ)Ljava/util/stream/LongStream;");
            _cachedMethodId18 = AndroidJNI.GetMethodID(_classObject, "longs", "(JJ)Ljava/util/stream/LongStream;");
            _cachedMethodId19 = AndroidJNI.GetMethodID(_classObject, "doubles", "(J)Ljava/util/stream/DoubleStream;");
            _cachedMethodId20 = AndroidJNI.GetMethodID(_classObject, "doubles", "()Ljava/util/stream/DoubleStream;");
            _cachedMethodId21 = AndroidJNI.GetMethodID(_classObject, "doubles", "(JDD)Ljava/util/stream/DoubleStream;");
            _cachedMethodId22 = AndroidJNI.GetMethodID(_classObject, "doubles", "(DD)Ljava/util/stream/DoubleStream;");
        }

        public SplittableRandom(long seed) : base(IntPtr.Zero)
        {
            try
            {
        ...
        public SplittableRandom() : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public SplittableRandom(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of SplittableRandom.");
                }
        ...
        public global::Java.Util.SplittableRandom Split()
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public static explicit operator IntPtr(SplittableRandom wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator SplittableRandom(IntPtr rawObject)
        {
            return new SplittableRandom(rawObject);
        }
