...
namespace Java.Util
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Util.NavigableMap<K, V>
        {
            ...
            public global::Java.Util.Map.Entry<K, V> LowerEntry(K key)
            {
                try
                {
                    ...
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId0, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> FloorEntry(K key)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(key)};
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId2, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> CeilingEntry(K key)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(key)};
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId4, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> HigherEntry(K key)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(key)};
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId6, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> FirstEntry()
            {
                try
                {
                    ...
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId8, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> LastEntry()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId9, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> PollFirstEntry()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId10, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Map.Entry<K, V> PollLastEntry()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Map.Entry<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId11, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableMap<K, V> DescendingMap()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.NavigableMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId12, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableSet<K> NavigableKeySet()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.NavigableSet<K>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId13, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableSet<K> DescendingKeySet()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.NavigableSet<K>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId14, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableMap<K, V> SubMap(K fromKey, bool fromInclusive, K toKey, bool toInclusive)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(fromKey), new jvalue { z = fromInclusive }, ToJvalue(toKey), new jvalue { z = toInclusive }};
                    return new global::Java.Util.NavigableMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId15, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableMap<K, V> HeadMap(K toKey, bool inclusive)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(toKey), new jvalue { z = inclusive }};
                    return new global::Java.Util.NavigableMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId16, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableMap<K, V> TailMap(K fromKey, bool inclusive)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(fromKey), new jvalue { z = inclusive }};
                    return new global::Java.Util.NavigableMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId17, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedMap<K, V> SubMap(K fromKey, K toKey)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(fromKey), ToJvalue(toKey)};
                    return new global::Java.Util.SortedMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId18, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedMap<K, V> HeadMap(K toKey)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId19, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedMap<K, V> TailMap(K fromKey)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedMap<K, V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId20, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<K> Comparator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Comparator<K>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId21, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Set<K> KeySet()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Set<K>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId24, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Collection<V> Values()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Collection<V>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId25, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Set<global::Java.Util.Map.Entry<K, V>> EntrySet()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Set<global::Java.Util.Map.Entry<K, V>>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId26, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Util.NavigableMap<K, V>
        {
            public CallbackHelper() : base("java.util.NavigableMap") {}
            ...
            {
            PutAll(new global::Java.Util.Map<K, V>.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject()));
            return null;
            }
