...
namespace Java.Lang
{
    public class UnsupportedOperationException : global::Java.Lang.RuntimeException
    {
        ...
        static UnsupportedOperationException()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/lang/UnsupportedOperationException");
        ...
        public UnsupportedOperationException() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public UnsupportedOperationException(global::System.String message) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public UnsupportedOperationException(global::System.String message, global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public UnsupportedOperationException(global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public UnsupportedOperationException(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of UnsupportedOperationException.");
                }
        ...
        public static explicit operator IntPtr(UnsupportedOperationException wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator UnsupportedOperationException(IntPtr rawObject)
        {
            return new UnsupportedOperationException(rawObject);
        }
