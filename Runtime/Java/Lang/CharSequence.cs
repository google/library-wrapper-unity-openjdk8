...
namespace Java.Lang
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Lang.CharSequence
        {
            ...
            public global::Java.Lang.CharSequence SubSequence(int start, int end)
            {
                try
                {
                    ...
                    return new global::Java.Lang.CharSequence.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId2, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Lang.CharSequence
        {
            public CallbackHelper() : base("java.lang.CharSequence") {}
