...
namespace Java.Util
{
    public class Timer : global::Google.LibraryWrapper.Java.JavaObject
    {
        ...
        public Timer(global::System.String name, bool isDaemon) : base(IntPtr.Zero)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = AndroidJNI.NewString(name) }, new jvalue { z = isDaemon }};
        ...
        public void Schedule(global::Java.Util.TimerTask task, long delay)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = task.GetRawObject() }, new jvalue { j = delay }};
        ...
        public void Schedule(global::Java.Util.TimerTask task, global::Java.Util.Date time)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = task.GetRawObject() }, new jvalue { l = time.GetRawObject() }};
        ...
        public void Schedule(global::Java.Util.TimerTask task, long delay, long period)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = task.GetRawObject() }, new jvalue { j = delay }, new jvalue { j = period }};
        ...
        public void Schedule(global::Java.Util.TimerTask task, global::Java.Util.Date firstTime, long period)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = task.GetRawObject() }, new jvalue { l = firstTime.GetRawObject() }, new jvalue { j = period }};
