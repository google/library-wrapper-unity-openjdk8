...
namespace Java.Lang
{
    public class Byte : global::Java.Lang.Number, global::Java.ExternalType.Java.Lang.Comparable<global::Java.Lang.Byte>
    {
        ...
        {
            get => AndroidJNI.GetStaticSByteField(_classObject, _cachedFieldId0);
            set => AndroidJNI.SetStaticSByteField(_classObject, _cachedFieldId0, value);
        }
        public static sbyte MAX_VALUE
        {
            get => AndroidJNI.GetStaticSByteField(_classObject, _cachedFieldId1);
            set => AndroidJNI.SetStaticSByteField(_classObject, _cachedFieldId1, value);
        }
        public static global::Java.Lang.Class<global::Java.Lang.Byte> TYPE
        {
            get => new global::Java.Lang.Class<global::Java.Lang.Byte>(AndroidJNI.GetStaticObjectField(_classObject, _cachedFieldId2));
            set
            {
        ...
        public Byte(sbyte value) : base(IntPtr.Zero)
        {
            try
            {
                ...
                jvalue[] args_ = new jvalue[] {new jvalue { b = value }};
        ...
        public static global::System.String ToString(sbyte b)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { b = b }};
        ...
        public static sbyte ParseByte(global::System.String s, int radix)
        {
            try
            {
                ...
                return AndroidJNI.CallStaticSByteMethod(_classObject, _cachedMethodId2, args_);
            }
            finally
            {
                AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public static sbyte ParseByte(global::System.String s)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { l = AndroidJNI.NewString(s) }};
                return AndroidJNI.CallStaticSByteMethod(_classObject, _cachedMethodId3, args_);
            }
            finally
            {
                AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public static int Compare(sbyte x, sbyte y)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { b = x }, new jvalue { b = y }};
        ...
        public static int ToUnsignedInt(sbyte x)
        {
            ...
            {
                AndroidJNI.PushLocalFrame(0);
                jvalue[] args_ = new jvalue[] {new jvalue { b = x }};
