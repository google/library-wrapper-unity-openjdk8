...
namespace Java.Util
{
    public class LinkedHashSet<E> : global::Java.Util.HashSet<E>, global::Java.Util.Set<E>, global::Java.Lang.Cloneable, global::Java.ExternalType.Java.Io.Serializable where E : class
    {
        ...
        static LinkedHashSet()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/util/LinkedHashSet");
        ...
        public LinkedHashSet(int initialCapacity, float loadFactor) : base(IntPtr.Zero)
        {
            try
            {
        ...
        public LinkedHashSet(int initialCapacity) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public LinkedHashSet() : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public LinkedHashSet(global::Java.Util.Collection<E> c) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public LinkedHashSet(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of LinkedHashSet.");
                }
        ...
        public static explicit operator IntPtr(LinkedHashSet<E> wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator LinkedHashSet<E>(IntPtr rawObject)
        {
            return new LinkedHashSet<E>(rawObject);
        }
