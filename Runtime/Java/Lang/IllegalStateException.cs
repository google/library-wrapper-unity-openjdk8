...
namespace Java.Lang
{
    public class IllegalStateException : global::Java.Lang.RuntimeException
    {
        ...
        static IllegalStateException()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/lang/IllegalStateException");
        ...
        public IllegalStateException() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public IllegalStateException(global::System.String s) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public IllegalStateException(global::System.String message, global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public IllegalStateException(global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public IllegalStateException(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of IllegalStateException.");
                }
        ...
        public static explicit operator IntPtr(IllegalStateException wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator IllegalStateException(IntPtr rawObject)
        {
            return new IllegalStateException(rawObject);
        }
