...
namespace Java.Lang
{
    public class Exception : global::Java.Lang.Throwable
    {
        ...
        static Exception()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/lang/Exception");
        ...
        public Exception() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public Exception(global::System.String message) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public Exception(global::System.String message, global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public Exception(global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public Exception(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of Exception.");
                }
        ...
        public static explicit operator IntPtr(Exception wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator Exception(IntPtr rawObject)
        {
            return new Exception(rawObject);
        }
