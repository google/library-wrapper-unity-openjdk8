...
namespace Java.Lang
{
    public class VirtualMachineError : global::Java.Lang.Error
    {
        ...
        static VirtualMachineError()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/lang/VirtualMachineError");
        ...
        public VirtualMachineError() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public VirtualMachineError(global::System.String message) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public VirtualMachineError(global::System.String message, global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public VirtualMachineError(global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public VirtualMachineError(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of VirtualMachineError.");
                }
        ...
        public static explicit operator IntPtr(VirtualMachineError wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator VirtualMachineError(IntPtr rawObject)
        {
            return new VirtualMachineError(rawObject);
        }
