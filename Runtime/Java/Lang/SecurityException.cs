...
namespace Java.Lang
{
    public class SecurityException : global::Java.Lang.RuntimeException
    {
        ...
        static SecurityException()
        {
            ...
            IntPtr classObject = AndroidJNI.FindClass("java/lang/SecurityException");
        ...
        public SecurityException() : base(IntPtr.Zero)
        {
            try
            {
        ...
        public SecurityException(global::System.String s) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public SecurityException(global::System.String message, global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public SecurityException(global::Java.Lang.Throwable cause) : base(IntPtr.Zero)
        {
            try
            {
                AndroidJNI.PushLocalFrame(0);
        ...
        public SecurityException(IntPtr rawObject) : base(IntPtr.Zero)
        {
            ...
            try
            {
                ...
                {
                    throw new ArgumentException("The provided reference is not an instance of SecurityException.");
                }
        ...
        public static explicit operator IntPtr(SecurityException wrapper)
        {
            return wrapper.GetRawObject();
        }

        public static explicit operator SecurityException(IntPtr rawObject)
        {
            return new SecurityException(rawObject);
        }
