...
namespace Java.Util
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Util.NavigableSet<E>
        {
            ...
            public global::Java.Util.Iterator<E> Iterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Iterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId6, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableSet<E> DescendingSet()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.NavigableSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId7, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Iterator<E> DescendingIterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Iterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId8, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableSet<E> SubSet(E fromElement, bool fromInclusive, E toElement, bool toInclusive)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(fromElement), new jvalue { z = fromInclusive }, ToJvalue(toElement), new jvalue { z = toInclusive }};
                    return new global::Java.Util.NavigableSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId9, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableSet<E> HeadSet(E toElement, bool inclusive)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(toElement), new jvalue { z = inclusive }};
                    return new global::Java.Util.NavigableSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId10, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.NavigableSet<E> TailSet(E fromElement, bool inclusive)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(fromElement), new jvalue { z = inclusive }};
                    return new global::Java.Util.NavigableSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId11, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedSet<E> SubSet(E fromElement, E toElement)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(fromElement), ToJvalue(toElement)};
                    return new global::Java.Util.SortedSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId12, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedSet<E> HeadSet(E toElement)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId13, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedSet<E> TailSet(E fromElement)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId14, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<E> Comparator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Comparator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId15, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Util.NavigableSet<E>
        {
            public CallbackHelper() : base("java.util.NavigableSet") {}
            ...
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(ContainsAll(new global::Java.Util.Collection<global::Google.LibraryWrapper.Java.JavaObject>.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject())));
            }
            else if (methodName == "addAll" && args.Length == 1)
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(AddAll(new global::Java.Util.Collection<E>.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject())));
            }
            else if (methodName == "retainAll" && args.Length == 1)
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(RetainAll(new global::Java.Util.Collection<global::Google.LibraryWrapper.Java.JavaObject>.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject())));
            }
            else if (methodName == "removeAll" && args.Length == 1)
            {
            return Google.LibraryWrapper.Java.Utils.ToAndroidJavaObject(RemoveAll(new global::Java.Util.Collection<global::Google.LibraryWrapper.Java.JavaObject>.AnonymousImplementation(((AndroidJavaObject) args[0]).GetRawObject())));
            }
