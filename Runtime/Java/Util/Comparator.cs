...
namespace Java.Util
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Util.Comparator<T>
        {
            ...
            public int Compare(T o1, T o2)
            {
                ...
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {ToJvalue(o1), ToJvalue(o2)};
            ...
            public global::Java.Util.Comparator<T> Reversed()
            {
                try
                {
                    ...
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId2, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<T> ThenComparing(global::Java.Util.Comparator<T> other)
            {
                try
                {
                    ...
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId3, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<T> ThenComparing<U>(global::Java.ExternalType.Java.Util.Function.Function<T, U> keyExtractor, global::Java.Util.Comparator<U> keyComparator) where U : class
            {
                try
                {
                    ...
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId4, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<T> ThenComparing<U>(global::Java.ExternalType.Java.Util.Function.Function<T, U> keyExtractor) where U : class, global::Java.ExternalType.Java.Lang.Comparable<U>
            {
                try
                {
                    ...
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId5, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<T> ThenComparingInt(global::Java.ExternalType.Java.Util.Function.ToIntFunction<T> keyExtractor)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { l = keyExtractor.GetRawObject() }};
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId6, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<T> ThenComparingLong(global::Java.ExternalType.Java.Util.Function.ToLongFunction<T> keyExtractor)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { l = keyExtractor.GetRawObject() }};
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId7, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Comparator<T> ThenComparingDouble(global::Java.ExternalType.Java.Util.Function.ToDoubleFunction<T> keyExtractor)
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {new jvalue { l = keyExtractor.GetRawObject() }};
                    return new global::Java.Util.Comparator<T>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId8, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Util.Comparator<T>
        {
            public CallbackHelper() : base("java.util.Comparator") {}
