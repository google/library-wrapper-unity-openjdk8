...
namespace Java.Util
{
    ...
    {
        public new class AnonymousImplementation : global::Google.LibraryWrapper.Java.JavaObject, global::Java.Util.SortedSet<E>
        {
            ...
            public global::Java.Util.Comparator<E> Comparator()
            {
                try
                {
                    ...
                    return new global::Java.Util.Comparator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId0, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedSet<E> SubSet(E fromElement, E toElement)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId1, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedSet<E> HeadSet(E toElement)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId2, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.SortedSet<E> TailSet(E fromElement)
            {
                try
                {
                    ...
                    return new global::Java.Util.SortedSet<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId3, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.ExternalType.Java.Util.Spliterator<E> Spliterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.ExternalType.Java.Util.Spliterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId6, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
            ...
            public global::Java.Util.Iterator<E> Iterator()
            {
                try
                {
                    AndroidJNI.PushLocalFrame(0);
                    jvalue[] args_ = new jvalue[] {};
                    return new global::Java.Util.Iterator<E>.AnonymousImplementation(AndroidJNI.CallObjectMethod(_rawObject, _cachedMethodId10, args_));
                }
                finally
                {
                    AndroidJNI.PopLocalFrame(IntPtr.Zero);
        ...
        public new abstract class CallbackHelper : global::Google.LibraryWrapper.Java.JavaProxy, global::Java.Util.SortedSet<E>
        {
            public CallbackHelper() : base("java.util.SortedSet") {}
